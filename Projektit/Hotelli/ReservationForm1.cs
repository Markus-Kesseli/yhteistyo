...
{
    public partial class ManageReservationsForm1 : Form
    {
        public ManageReservationsForm1()
        {
            InitializeComponent();
        }
        ...
        private void ManageReservationsForm_Load(object sender, EventArgs e)
        {
            ...
            tbClientID.DisplayMember = "label";
            tbClientID.ValueMember = "id";

            //display free room's number depending on selected type
            int type = Convert.ToInt32(tbClientID.SelectedValue.ToString());
        ...
        private void dgvReservations_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //room type from ddl
            tbClientID.SelectedValue = room.GetRoomType(roomID);
