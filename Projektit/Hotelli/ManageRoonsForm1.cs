...
{
    public partial class ManageRoomsForm1: Form
    {
        public ManageRoomsForm1()
        {
            InitializeComponent();
        }

        ROOM room = new ROOM();
        private void ManageRoomsForm1_Load(object sender, EventArgs e)
        {
        ...
        private void btnClearFields1_Click(object sender, EventArgs e)
        {
            tbNumber.Text = "";
        ...
        private void dgvRooms1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void ManageRoomsForm1_Load_1(object sender, EventArgs e)
        {
