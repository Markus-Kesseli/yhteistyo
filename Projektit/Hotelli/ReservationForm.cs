...
namespace Hotel_System
{
    class Reservations
    {
        ...
        public bool MakeReservation1(int number, int client, DateTime dateIn, DateTime dateOut)
        {
        ...
        //edit reservation
        public bool EditReservation1(int id, int number, int client, DateTime dateIn, DateTime dateOut)
        {
            MySqlCommand command = new MySqlCommand();
        ...
        //remove room
        public bool RemoveReservation1(int id)
        {
            MySqlCommand command = new MySqlCommand();
